...
<div id="auth-view" class="auth-split">
  ...
  <div class="auth-form-panel">
    <div style="width:100%;max-width:380px">
      ...
      <div id="auth-fields">
        ...
        <div class="form-group">
          ...
          <div id="forgot-link-container" style="text-align:right;margin-top:8px">
            <a onclick="setAuthMode('forgot')" style="font-size:12px;color:var(--color-accent);cursor:pointer;font-weight:500">
              Forgot password?
            </a>
          </div>
        </div>
      ...
      <button onclick="submitAuth()" class="btn" style="width:100%;padding:11px 18px;font-size:14px;font-weight:600" id="auth-btn">
        Sign In
      </button>

      <div id="auth-footer" style="text-align:center;margin-top:24px;font-size:14px;color:var(--text-secondary)">
        <span id="auth-toggle-text">Don't have an account?</span>
        <a onclick="toggleAuthMode()" style="color:var(--color-accent);cursor:pointer;font-weight:600;margin-left:4px" id="auth-toggle-link">
          Create one free
        </a>
      </div>

      <div id="back-to-login" class="hidden" style="text-align:center;margin-top:20px;font-size:14px">
        <a onclick="setAuthMode('login')" style="color:var(--text-secondary);cursor:pointer">
          &larr; Back to login
        </a>
      </div>
