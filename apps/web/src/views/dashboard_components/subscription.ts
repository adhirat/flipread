export const subscriptionView = `
  ...
  <div id="view-subscription" class="view-section">
    ...
    <div class="billing-toggle">
      ...
      <span id="bill-yearly" class="toggle-label active" onclick="setBilling('yearly')">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:20px;align-items:start">
      ...
      <div class="card" style="margin-bottom:0">
        ...
        <button onclick="checkout('basic')" class="btn btn-outline" style="width:100%;justify-content:center">Choose Basic</button>
      </div>
      ...
      <div class="card" style="margin-bottom:0;border-color:var(--color-accent);box-shadow:var(--shadow-md);position:relative;padding-top:44px">
        ...
        <button onclick="checkout('pro')" class="btn" style="width:100%;justify-content:center">Choose Pro</button>
      </div>
      ...
      <div class="card" style="margin-bottom:0">
        ...
        <button onclick="checkout('business')" class="btn btn-outline" style="width:100%;justify-content:center">Choose Business</button>
      </div>
