    ...
    <div id="view-dashboard" class="view-section">
      ...
      <div class="card">
        ...
        <div style="display:flex;gap:12px;flex-wrap:wrap">
          <button x-on:click="currentView = 'docs'" class="btn">
            <i class="fas fa-file-alt"></i> Manage Docs
          </button>
          <button x-on:click="currentView = 'store'" class="btn btn-outline">
            <i class="fas fa-store"></i> Customize Store
          </button>
          <button x-on:click="currentView = 'products'" class="btn btn-outline">
