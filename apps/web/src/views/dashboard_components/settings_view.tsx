        ...
        <div id="view-settings" class="view-section">
          ...
          <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(350px,1fr));gap:24px">
            ...
            <div class="card">
              ...
              <button x-on:click="window.saveProfile()" class="btn" style="width:100%">Update Profile</button>
            </div>
            ...
            <div class="card">
              ...
              <div class="form-group">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
                  <button x-on:click="window.setTheme('light')" id="theme-btn-light" class="btn-outline" style="display:flex;flex-direction:column;gap:8px;padding:20px 10px;align-items:center">
                    <i class="fas fa-sun" style="font-size:20px"></i>
                    Light Mode
                  </button>
                  <button x-on:click="window.setTheme('dark')" id="theme-btn-dark" class="btn-outline" style="display:flex;flex-direction:column;gap:8px;padding:20px 10px;align-items:center">
              ...
              <div class="form-group" id="branding-section" style="display:none">
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;padding:16px;background:var(--bg-elevated);border-radius:12px">
                  ...
                  <div class="toggle-switch active" id="branding-toggle" x-on:click="window.toggleBranding()">
            ...
            <div class="card" id="api-section" style="display:none">
              ...
              <button x-on:click="window.generateApiKey()" class="btn-outline" style="width:100%;justify-content:center"><i class="fas fa-plus"></i> Generate New Key</button>
            </div>
            ...
            <div class="card">
              ...
              <button x-on:click="window.location.href='mailto:support@SHOPUBLISH.COM'" class="btn-outline" style="width:100%;justify-content:center">Contact Support</button>
            </div>
            ...
            <div class="card" style="border-color:rgba(239,68,68,0.1)">
              ...
              <div class="form-group">
                <label>Session</label>
                <button x-on:click="window.logout()" class="btn btn-outline" style="width:100%;justify-content:center;color:#ef4444;border-color:rgba(239,68,68,0.2)">
              ...
              <div style="margin-top:32px;padding-top:24px;border-top:1px solid var(--border)">
                 ...
                 <button x-on:click="window.confirmDeleteAccount()" class="btn-outline danger-btn" 
        ...
        <div id="delete-modal" class="modal">
          <div class="modal-content" style="max-width:400px;text-align:center">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:20px">
              <button x-on:click="window.hideModal('delete-modal')" class="btn-outline" style="justify-content:center">Cancel</button>
              <button x-on:click="window.executeDeleteAccount()" class="btn" style="background:#ef4444;justify-content:center">Delete</button>
            </div>
          </div>
        </div>
