    ...
    <>
        ...
        <div id="view-promotions" class="view-section">
          <div class="view-header">
            ...
            <div style="display:flex;gap:12px">
                <button class="btn" x-on:click="window.showPromoModal()"><i class="fas fa-plus"></i> New Promotion</button>
            </div>
          </div>
        ...
        <div id="edit-promo-modal" class="modal">
          <div class="modal-content" style="max-width:500px">
            <div class="close-btn" x-on:click="window.hideModal('edit-promo-modal')">&times;</div>
            ...
            <div style="display:flex;justify-content:flex-end;gap:12px;margin-top:24px">
              <button x-on:click="window.hideModal('edit-promo-modal')" class="btn-outline" style="border:none">Cancel</button>
              <button id="submit-promo-btn" x-on:click="window.savePromo()" class="btn">Save Promotion</button>
            </div>
          </div>
        </div>
    </>
