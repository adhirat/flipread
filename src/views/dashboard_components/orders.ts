export const ordersView = `
    ...
    <div id="edit-order-modal" class="modal">
      <div class="modal-content" style="max-width:600px; max-height:80vh; overflow-y:auto;">
        <div class="close-btn" onclick="hideModal('edit-order-modal')">&times;</div>
        ...
        <div style="display:flex;justify-content:flex-end;gap:12px;margin-top:24px">
          <button onclick="hideModal('edit-order-modal')" class="btn-outline" style="border:none">Cancel</button>
          <button id="submit-order-btn" onclick="saveOrder()" class="btn">Update Order</button>
        </div>
      </div>
    </div>
`;
