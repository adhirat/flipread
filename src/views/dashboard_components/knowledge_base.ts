      ...
      <div class="kb-container" style="display:flex;gap:30px;max-width:1000px">
        ...
        <div class="kb-sidebar" style="width:240px;flex-shrink:0;position:sticky;top:80px;align-self:start">
          <div class="kb-nav" style="border-right:1px solid var(--border);padding-right:20px">
            ...
            <a href="#kb-getting-started" class="kb-link active" onclick="scrollToKb('kb-getting-started');return false">Getting Started</a>
            <a href="#kb-managing-books" class="kb-link" onclick="scrollToKb('kb-managing-books');return false">Managing Books</a>
            
            <h4 style="margin:24px 0 12px;font-size:12px;text-transform:uppercase;letter-spacing:1px;color:var(--text-muted)">Store</h4>
            <a href="#kb-customization" class="kb-link" onclick="scrollToKb('kb-customization');return false">Store Customization</a>
            <a href="#kb-domains" class="kb-link" onclick="scrollToKb('kb-domains');return false">Custom Domains</a>
            <a href="#kb-members" class="kb-link" onclick="scrollToKb('kb-members');return false">Team Members</a>
            
            <h4 style="margin:24px 0 12px;font-size:12px;text-transform:uppercase;letter-spacing:1px;color:var(--text-muted)">Advanced</h4>
            <a href="#kb-analytics" class="kb-link" onclick="scrollToKb('kb-analytics');return false">Analytics</a>
            <a href="#kb-api" class="kb-link" onclick="scrollToKb('kb-api');return false">API Access</a>
            <a href="#kb-billing" class="kb-link" onclick="scrollToKb('kb-billing');return false">Billing & Plans</a>
          </div>
        </div>
        ...
        <div class="kb-content" style="flex:1">
          ...
          <section id="kb-getting-started" class="kb-section">
            ...
            <p>Welcome to FlipRead! Our platform helps you publish, sell, and share your PDF and EPUB books with a premium reading experience.</p>
            <div class="kb-card">
          ...
          <section id="kb-domains" class="kb-section" style="margin-top:40px">
            ...
            <ol style="margin-left:20px;line-height:1.8">
              ...
              <li>Point it to <code>flipread.flipread.workers.dev</code>.</li>
