export const productsView = `
    ...
    <div id="view-products" class="view-section">
      <div class="view-header">
        ...
        <div style="display:flex;gap:12px">
            <button class="btn" onclick="showProductModal()"><i class="fas fa-plus"></i> New Product</button>
        </div>
      </div>
    ...
    <div id="edit-product-modal" class="modal">
      <div class="modal-content" style="max-width:600px; max-height:80vh; overflow-y:auto;">
        <div class="close-btn" onclick="hideModal('edit-product-modal')">&times;</div>
        ...
        <div style="display:flex;justify-content:flex-end;gap:12px;margin-top:24px">
          <button onclick="hideModal('edit-product-modal')" class="btn-outline" style="border:none">Cancel</button>
          <button id="submit-product-btn" onclick="saveProduct()" class="btn">Save Product</button>
        </div>
      </div>
    </div>
`;
