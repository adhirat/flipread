  ...
  <body class="fit-mode light-ui" style="background: #ffffff">
      ...
      <header class="hdr" id="main-hdr">
          ...
          <div class="flex items-center gap-1 sm:gap-2 shrink-0">
              ...
              <button class="hdr-i !bg-transparent" id="tts-btn" onclick="toggleTTS()" title="Listen (TTS)">
      ...
      <div id="chat-w">
          ...
          <div class="chat-b">
              ...
              <div id="chat-highlights" class="chat-tab-c">
                  <p class="text-[10px] text-center opacity-40 py-10 mt-20">Highlights feature coming soon for Presentations.</p>
              </div>
          </div>
                  ...
                  <div id="p-in" class="tab-content">
                      ...
                      <div class="flex flex-col gap-4 text-[13px] leading-relaxed opacity-90">
                          <div class="flex gap-4">
                              <i class="fas fa-desktop mt-1 text-${accent} text-lg"></i>
                          ...
                          <div class="md:hidden pt-4 border-t border-white/5 flex flex-col gap-4">
                              <div class="flex items-center justify-between">
                                  <span class="text-[11px]">Presentation Zoom</span>
      ...
      <script>
          ...
          async function initPpt() {
              try {
                  // PPTXJS requires URL, it can handle it.
                  // But note: pptxjs uses jquery element matching.
                  $("#ppt-c").pptxToHtml({
                      pptxFileUrl: FU,
                      slidesScale: "50%", 
                      slideMode: false,
                  ...
                  // Poll for completion (hacky but pptxjs doesn't return promise easily)
                  ...
                  // Failsafe
                  setTimeout(() => { clearInterval(check); document.getElementById('ld').style.display='none'; }, 10000);
                  
              } catch(e) {
                  document.getElementById('ld').innerHTML = '<i class="fas fa-exclamation-triangle text-red-500"></i><p>Error Loading Presentation</p>';
              }
          }
          ...
          function applyZoom() {
              document.getElementById('ppt-c').style.transform = 'scale(' + zoom + ')';
          ...
          // Touch Swiping for Presentation Slides
          let ts=0, ty=0;
          ...
          window.startTTS = () => {
              const container = document.getElementById('ppt-c');
              if(!container) return;
