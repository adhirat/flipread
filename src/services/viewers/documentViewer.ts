...
<body class="fit-mode light-ui" style="background: #ffffff">
    ...
    <header class="hdr" id="main-hdr">
        ...
        <div class="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <button class="w-8 h-8 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 border border-white/10 backdrop-blur-md transition hidden sm:flex" id="m-btn" onclick="toggleLayout()" title="Toggle Layout"><i class="fas fa-expand text-xs"></i></button>
        </div>
    </header>
                ...
                <div id="p-in" class="tab-content">
                    ...
                    <div class="flex flex-col gap-4 text-[13px] leading-relaxed opacity-90">
                        <div class="flex gap-4">
                            <i class="fas fa-arrows-alt-v mt-1 text-${accent} text-lg"></i>
