...
<body class="fit-mode light-ui" style="background: #ffffff">
    ...
    <header class="hdr" id="main-hdr">
        ...
        <div class="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <button class="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/10 transition hidden sm:flex" id="m-btn" onclick="toggleLayout()" title="Toggle Layout"><i class="fas fa-expand text-xs"></i></button>
        </div>
    </header>
